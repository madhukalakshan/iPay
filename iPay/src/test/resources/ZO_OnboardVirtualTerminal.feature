Feature: Feature File for Onboarding Virtual Terminal

  @OnbordingVirtualTerminal
  ...
  Scenario: Perform Transaction from Virtual Terminal(To Void)
    And I "fill" data criteria of "Virtual Terminal"
      ...
      | merchantReferenceId |        311111149 | Name       | Textbox     |
  ...
  Scenario: Void Transaction
    ...
    Then I veify DB values to "Onboard" Void Transaction which did from "virtual terminal"
  ...
  Scenario: Perform Transaction from Virtual Terminal
    ...
    And I "fill" data criteria of "Virtual Terminal"
      ...
      | amount              |           100.00 | Name       | Textbox     |
      | currencyCode        | NPR              | Name,Value | Dropdown    |
      | merchantReferenceId |        411111149 | Name       | Textbox     |
    And I click on "Pay Now" button in "Login to Transaction Management"
      | Element | option |
      | submit  | Name   |
    Then I should see the "Virtual Terminal" page
  ...
  Scenario: Mark Suspisious Transaction
    ...
    Then I veify DB values to "Onboard" Mark Suspisious Transaction which did from "virtual terminal"
  ...
  Scenario: Unmark Suspisious Transaction
    ...
    Then I veify DB values to "Onboard" Unmark Suspisious Transaction which did from "virtual terminal"
  ...
  Scenario: Clear Transaction
    ...
    Then I veify DB values to "Onboard" Clear Transaction which did from "virtual terminal"
  ...
  Scenario: Batch Transactions
    ...
    Then I veify DB values to "Onboard" Batch Transaction which did from "virtual terminal"
