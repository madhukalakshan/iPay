Feature: Feature File for iPay Transaction Management to onboarding
  ...
  Scenario: Navigate to Transaction Management
    ...
    Then I should see the "Application Menu" page to "Transaction Management"
    And I Click the "iPay-Merchant" icon to "Transaction Management"
    Then I should see "iPay-Merchant" Home Page
  ...
  Scenario: Void Transaction
    ...
    Then I veify DB values to "Onbording" Void Transaction which did from "PHP Client"
  ...
  Scenario: Mark Suspisious Transaction
    ...
    Then I veify DB values to "Onbording" Mark Suspisious Transaction which did from "PHP Client"
  ...
  Scenario: Unmark Suspisious Transaction
    ...
    Then I veify DB values to "Onbording" Unmark Suspisious Transaction which did from "PHP Client"
  ...
  Scenario: Clear Transaction
    ...
    Then I veify DB values to "Onbording" Clear Transaction which did from "PHP Client"
  ...
  Scenario: Batch Transactions
    ...
    Then I veify DB values to "Onbording" Batch Transaction which did from "PHP Client"
