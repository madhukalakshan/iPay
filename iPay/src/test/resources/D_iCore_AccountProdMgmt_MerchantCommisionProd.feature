...
#ProdTyp				30MERCOMCUC
####################################################################################
Feature: iCore Account Product Management(Merchant Commission product)
  ...
  Scenario: Create Account Product in iCore module
    ...
    And I fill the account product Creation form for Account Type "CMSN"
      | field       | value                               |
      | AcctTyp     | CMSN                                |
      | ProdTyp     | 30MERCOMCUC                         |
      | Description | MERCHANT COMMISION PRODUCT CUCUMBER |
      | CurrTyp     |                                 524 |
    ...
    Then I call verify method
      ...
      | ICORE | SELECT COUNT(*) FROM BKN_DP_ACCT_PROD WHERE PRODUCT_TYPE_ID='30MERCOMCUC' AND ACCT_TYP='CMSN' AND STATUS_CODE=5 |                  1 |
  ...
  Scenario: Reject Account Product
    ...
    Then I call verify method
      | Alias | SQL                                                                                                             | Expected Row Count |
      | ICORE | SELECT COUNT(*) FROM BKN_DP_ACCT_PROD WHERE PRODUCT_TYPE_ID='30MERCOMCUC' AND ACCT_TYP='CMSN' AND STATUS_CODE=4 |                  1 |
  ...
  Scenario: ReApply Account Product
    ...
    Then I call verify method
      | Alias | SQL                                                                                                             | Expected Row Count |
      | ICORE | SELECT COUNT(*) FROM BKN_DP_ACCT_PROD WHERE PRODUCT_TYPE_ID='30MERCOMCUC' AND ACCT_TYP='CMSN' AND STATUS_CODE=2 |                  1 |
  ...
  Scenario: Approve Account Product
    ...
    And I click the link "Details"
    Then I should see the "Approve Account Product" page
    And I Enter the Comment "Approve Account Product" in "Approve Account Product"
      | Element | Option |
      | Comment | id     |
    And I Click on Button "Submit1"
    ...
    Then I call verify method
      | Alias | SQL                                                                                                             | Expected Row Count |
      | ICORE | SELECT COUNT(*) FROM BKN_DP_ACCT_PROD WHERE PRODUCT_TYPE_ID='30MERCOMCUC' AND ACCT_TYP='CMSN' AND STATUS_CODE=1 |                  1 |
      | ICORE | SELECT COUNT(*) FROM BKN_DM_ACCT_PROD WHERE PRODUCT_TYPE_ID='30MERCOMCUC' AND ACCT_TYP='CMSN' AND STATUS_CODE=1 |                  1 |
  ...
  Scenario: Edit Account Product
    ...
    Then I call verify method
      | Alias | SQL                                                                                                             | Expected Row Count |
      | ICORE | SELECT COUNT(*) FROM BKN_DP_ACCT_PROD WHERE PRODUCT_TYPE_ID='30MERCOMCUC' AND ACCT_TYP='CMSN' AND STATUS_CODE=3 |                  1 |
      | ICORE | SELECT COUNT(*) FROM BKN_DM_ACCT_PROD WHERE PRODUCT_TYPE_ID='30MERCOMCUC' AND ACCT_TYP='CMSN' AND STATUS_CODE=1 |                  1 |
  ...
  Scenario: Suspend Account Product
    ...
    Then I call verify method
      | Alias | SQL                                                                                                             | Expected Row Count |
      | ICORE | SELECT COUNT(*) FROM BKN_DP_ACCT_PROD WHERE PRODUCT_TYPE_ID='30MERCOMCUC' AND ACCT_TYP='CMSN' AND STATUS_CODE=6 |                  1 |
      | ICORE | SELECT COUNT(*) FROM BKN_DM_ACCT_PROD WHERE PRODUCT_TYPE_ID='30MERCOMCUC' AND ACCT_TYP='CMSN' AND STATUS_CODE=6 |                  1 |
  ...
  Scenario: Revoke Account Product
    ...
    Then I call verify method
      | Alias | SQL                                                                                                             | Expected Row Count |
      | ICORE | SELECT COUNT(*) FROM BKN_DP_ACCT_PROD WHERE PRODUCT_TYPE_ID='30MERCOMCUC' AND ACCT_TYP='CMSN' AND STATUS_CODE=7 |                  1 |
      | ICORE | SELECT COUNT(*) FROM BKN_DM_ACCT_PROD WHERE PRODUCT_TYPE_ID='30MERCOMCUC' AND ACCT_TYP='CMSN' AND STATUS_CODE=6 |                  1 |
