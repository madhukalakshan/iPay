...
# As per the below file product type 30MERCOMCUC should be in active state for this feature file to succeed.
###############################################################################################################################################
Feature: iCore Account Management(Commission Account)

  @resetiImageCounter @CommAcc
  ...
  Scenario: Create Account in iCore module
    ...
    And I fill the account Creation form for Account Type "CMSN"
      | field             | value          |
      | PrdTyp            | 30MERCOMCUC    |
      | BrnchId           |          00000 |
      | CoreAcct          |      123475824 |
    ...
    Then I should see the Success message as "Account Added successfully" for Merchant Commission Account Added
    Then I call verify method
      | Alias | SQL                                                                                                                                                                                                                                                                                  | Expected Row Count |
      | ICORE | SELECT COUNT(*) FROM BKN_DM_ACCT_PROF WHERE PRDUCT_TYPE_ID ='30MERCOMCUC' and  ADDED_BY='MADHUKA' AND STATUS_CODE=1                                                                                                                                                                  |                  1 |
      | ICORE | SELECT COUNT(*) FROM BKN_DP_CNCT_DET WHERE CNCT_LNK_TBL='BKN_DM_ACCT' AND CNCT_REF = (SELECT TRIM (BOTH ' ' from TO_CHAR(ACCOUNT_SERIAL_NUMBER, '9999999999999999999999')) FROM BKN_DM_ACCT_PROF WHERE PRDUCT_TYPE_ID ='30MERCOMCUC' and  ADDED_BY='MADHUKA') AND ADDED_BY='MADHUKA' |                  8 |
    Then I verify "Commission Account" status "5"
  ...
  Scenario: Reject Account
    ...
    And I fill Merchant Commission Account to Account Number TextBox
    And I Click on Button "Submit"
    ...
    Then I call verify method
      ...
      | ICORE | SELECT COUNT(*) FROM BKN_DM_ACCT_PROF WHERE PRDUCT_TYPE_ID ='30MERCOMCUC' and  ADDED_BY='MADHUKA' AND STATUS_CODE=1                                                                                                                                                                  |                  1 |
      | ICORE | SELECT COUNT(*) FROM BKN_DP_CNCT_DET WHERE CNCT_LNK_TBL='BKN_DM_ACCT' AND CNCT_REF = (SELECT TRIM (BOTH ' ' from TO_CHAR(ACCOUNT_SERIAL_NUMBER, '9999999999999999999999')) FROM BKN_DM_ACCT_PROF WHERE PRDUCT_TYPE_ID ='30MERCOMCUC' and  ADDED_BY='MADHUKA') AND ADDED_BY='MADHUKA' |                  8 |
    Then I verify "Commission Account" status "4"
  ...
  Scenario: ReApply Account
    ...
    Then I call verify method
      ...
      | ICORE | SELECT COUNT(*) FROM BKN_DM_ACCT_PROF WHERE PRDUCT_TYPE_ID ='30MERCOMCUC' and  ADDED_BY='MADHUKA' AND STATUS_CODE=1                                                                                                                                                                  |                  1 |
      | ICORE | SELECT COUNT(*) FROM BKN_DP_CNCT_DET WHERE CNCT_LNK_TBL='BKN_DM_ACCT' AND CNCT_REF = (SELECT TRIM (BOTH ' ' from TO_CHAR(ACCOUNT_SERIAL_NUMBER, '9999999999999999999999')) FROM BKN_DM_ACCT_PROF WHERE PRDUCT_TYPE_ID ='30MERCOMCUC' and  ADDED_BY='MADHUKA') AND ADDED_BY='MADHUKA' |                  8 |
    Then I verify "Commission Account" status "2"
  ...
  Scenario: Approve reapplied Account
    ...
    Then I call verify method
      ...
      | ICORE | SELECT COUNT(*) FROM BKN_DP_CNCT_DET WHERE CNCT_LNK_TBL='BKN_DM_ACCT' AND CNCT_REF = (SELECT TRIM (BOTH ' ' from TO_CHAR(ACCOUNT_SERIAL_NUMBER, '9999999999999999999999')) FROM BKN_DM_ACCT_PROF WHERE PRDUCT_TYPE_ID ='30MERCOMCUC' and  ADDED_BY='MADHUKA') AND ADDED_BY='MADHUKA' |                  8 |
      | ICORE | SELECT COUNT(*) FROM BKN_DP_CNCT_DET WHERE CNCT_LNK_TBL='BKN_DM_ACCT' AND CNCT_REF = (SELECT TRIM (BOTH ' ' from TO_CHAR(ACCOUNT_SERIAL_NUMBER, '9999999999999999999999')) FROM BKN_DM_ACCT_PROF WHERE PRDUCT_TYPE_ID ='30MERCOMCUC' and  ADDED_BY='MADHUKA') AND ADDED_BY='MADHUKA' |                  8 |
    Then I verify "Commission Account" status "1"
  ...
  Scenario: Edit Account
    ...
    Then I call verify method
      ...
      | ICORE | SELECT COUNT(*) FROM BKN_DP_CNCT_DET WHERE CNCT_LNK_TBL='BKN_DM_ACCT' AND CNCT_REF = (SELECT TRIM (BOTH ' ' from TO_CHAR(ACCOUNT_SERIAL_NUMBER, '9999999999999999999999')) FROM BKN_DM_ACCT_PROF WHERE PRDUCT_TYPE_ID ='30MERCOMCUC' and  ADDED_BY='MADHUKA') AND ADDED_BY='MADHUKA' |                  8 |
      | ICORE | SELECT COUNT(*) FROM BKN_DP_CNCT_DET WHERE CNCT_LNK_TBL='BKN_DM_ACCT' AND CNCT_REF = (SELECT TRIM (BOTH ' ' from TO_CHAR(ACCOUNT_SERIAL_NUMBER, '9999999999999999999999')) FROM BKN_DM_ACCT_PROF WHERE PRDUCT_TYPE_ID ='30MERCOMCUC' and  ADDED_BY='MADHUKA') AND ADDED_BY='MADHUKA' |                  8 |
    Then I verify "Commission Account" status "3"
  ...
  Scenario: Suspend Account
    ...
    Then I call verify method
      ...
      | ICORE | SELECT COUNT(*) FROM BKN_DP_CNCT_DET WHERE CNCT_LNK_TBL='BKN_DM_ACCT' AND CNCT_REF = (SELECT TRIM (BOTH ' ' from TO_CHAR(ACCOUNT_SERIAL_NUMBER, '9999999999999999999999')) FROM BKN_DM_ACCT_PROF WHERE PRDUCT_TYPE_ID ='30MERCOMCUC' and  ADDED_BY='MADHUKA') AND ADDED_BY='MADHUKA' |                  8 |
      | ICORE | SELECT COUNT(*) FROM BKN_DP_CNCT_DET WHERE CNCT_LNK_TBL='BKN_DM_ACCT' AND CNCT_REF = (SELECT TRIM (BOTH ' ' from TO_CHAR(ACCOUNT_SERIAL_NUMBER, '9999999999999999999999')) FROM BKN_DM_ACCT_PROF WHERE PRDUCT_TYPE_ID ='30MERCOMCUC' and  ADDED_BY='MADHUKA') AND ADDED_BY='MADHUKA' |                  8 |
    Then I verify "Commission Account" status "6"
  ...
  Scenario: Revoke Account
    ...
    Then I call verify method
      ...
      | ICORE | SELECT COUNT(*) FROM BKN_DP_CNCT_DET WHERE CNCT_LNK_TBL='BKN_DM_ACCT' AND CNCT_REF = (SELECT TRIM (BOTH ' ' from TO_CHAR(ACCOUNT_SERIAL_NUMBER, '9999999999999999999999')) FROM BKN_DM_ACCT_PROF WHERE PRDUCT_TYPE_ID ='30MERCOMCUC' and  ADDED_BY='MADHUKA') AND ADDED_BY='MADHUKA' |                  8 |
      | ICORE | SELECT COUNT(*) FROM BKN_DP_CNCT_DET WHERE CNCT_LNK_TBL='BKN_DM_ACCT' AND CNCT_REF = (SELECT TRIM (BOTH ' ' from TO_CHAR(ACCOUNT_SERIAL_NUMBER, '9999999999999999999999')) FROM BKN_DM_ACCT_PROF WHERE PRDUCT_TYPE_ID ='30MERCOMCUC' and  ADDED_BY='MADHUKA') AND ADDED_BY='MADHUKA' |                  8 |
    Then I verify "Commission Account" status "7"
